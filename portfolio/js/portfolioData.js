...
window.PORTFOLIO_DATA = {
  ...
  projects: [
    // ─── CHENNAI SILKS — Campaign Cut (Featured First) ───
    {
      ...
      aspectRatio: "9:16",
      videoUrl: getBlobUrl("CHENNAI_SILKS_CAMPAIGN", "/BRAND SHOOT/chennai_silks_campaign.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
    ...
    // ─── CHENNAI SILKS — Brand Commercial (Social Media) ───
    {
      ...
      category: "Social Media",
      aspectRatio: "16:9",
      videoUrl: getBlobUrl("CHENNAI_SILKS_1", "/BRAND SHOOT/chennai_silks_1.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Chennai Silks"
    },
    {
      ...
      category: "Social Media",
      aspectRatio: "16:9",
      videoUrl: getBlobUrl("CHENNAI_SILKS_2", "/BRAND SHOOT/chennai_silks_2.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Chennai Silks"
    },
    {
      ...
      aspectRatio: "16:9",
      videoUrl: getBlobUrl("CHENNAI_SILKS_3", "/BRAND SHOOT/chennai_silks_3.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Chennai Silks"
    },
    {
      ...
      category: "Social Media",
      aspectRatio: "16:9",
      videoUrl: getBlobUrl("CHENNAI_SILKS_4", "/BRAND SHOOT/chennai_silks_4.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Chennai Silks"
    },
    {
      ...
      category: "Social Media",
      aspectRatio: "16:9",
      videoUrl: getBlobUrl("CHENNAI_SILKS_5", "/BRAND SHOOT/chennai_silks_5.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Chennai Silks"
    ...
    // ─── THINK MUSIC — YouTube Editing ───
    {
      ...
      aspectRatio: "16:9",
      videoUrl: getBlobUrl("THINK_MUSIC_1", "/BRAND SHOOT/think_music_1.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Think Music"
    },
    {
      ...
      category: "YouTube Editing",
      aspectRatio: "16:9",
      videoUrl: getBlobUrl("THINK_MUSIC_2", "/BRAND SHOOT/think_music_2.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Think Music"
    },
    {
      ...
      category: "YouTube Editing",
      aspectRatio: "16:9",
      videoUrl: getBlobUrl("THINK_MUSIC_3", "/BRAND SHOOT/think_music_3.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Think Music"
    ...
    // ─── BTS REELS — Vertical 9:16 Short-Form ───
    {
      ...
      aspectRatio: "9:16",
      videoUrl: getBlobUrl("BTS_1", "/BRAND SHOOT/bts_reel_1.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Brand BTS"
    },
    {
      ...
      category: "Reels & Shorts",
      aspectRatio: "9:16",
      videoUrl: getBlobUrl("BTS_2", "/BRAND SHOOT/bts_reel_2.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Brand BTS"
    },
    {
      ...
      category: "Reels & Shorts",
      aspectRatio: "9:16",
      videoUrl: getBlobUrl("BTS_3", "/BRAND SHOOT/bts_reel_3.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Brand BTS"
    },
    {
      ...
      category: "Reels & Shorts",
      aspectRatio: "9:16",
      videoUrl: getBlobUrl("BTS_4", "/BRAND SHOOT/bts_reel_4.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Brand BTS"
    },
    {
      ...
      category: "Reels & Shorts",
      aspectRatio: "9:16",
      videoUrl: getBlobUrl("BTS_5", "/BRAND SHOOT/bts_reel_5.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Brand BTS"
    },
    {
      ...
      category: "Reels & Shorts",
      aspectRatio: "9:16",
      videoUrl: getBlobUrl("BTS_6", "/BRAND SHOOT/bts_reel_6.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Brand BTS"
    },
    {
      ...
      category: "Reels & Shorts",
      aspectRatio: "9:16",
      videoUrl: getBlobUrl("BTS_7", "/BRAND SHOOT/bts_reel_7.mp4"),
      thumbnailUrl: "",
      description: "",
      tools: [],
      client: "Brand BTS"
